...
<sc version="201602" id="9" name="SC09" frequency="1" steps="0" defaultIntergreenMatrix="1" EPICSTimeHorizon="100000" EPICSLogLevel="1" interstagesUsingMinDurations="false" checkSum="2857502403">
  <signaldisplays>
  ...
  <sgs>
    ...
    <sg id="4" name="SG4" defaultSignalSequence="3" underEPICSControl="true">
      ...
      <EPICSTrafficDemands>
        ...
        <EPICSPTDemand maximumSpeed="50" weight0="100" weight="100" weight2="100" weight3="100" timeRequirement="4000" helpSignalGroup="0" competingSignalGroup="0" active="true">
          <PTDetectionPoints>
            <PTDetectionPoint travelTime="90000" callingPointPair="2" hasOwnLane="false" fastestTravelTime="83000" slowTravelTime="102000" slowestTravelTime="110000" />
          </PTDetectionPoints>
        </EPICSPTDemand>
      </EPICSTrafficDemands>
    </sg>
  ...
  <dets>
    <det id="1" name="09_Crosswalk_1" />
    <det id="2" name="09_Crosswalk_3" />
    <det id="3" name="09_SG_1_Lane2" />
    <det id="4" name="09_SG_2_Lane3" />
    <det id="5" name="09_SG_2_BusLogOff_Lane3" />
    <det id="6" name="09_SG_2_BusLogOn_Lane3" />
    <det id="7" name="09_SG_3_Lane1" />
    <det id="8" name="09_SG_4_Lane3" />
    <det id="9" name="09_SG_4_BusLogOff_Lane3" />
    <det id="10" name="09_SG_4_BusLogOn_Lane3" />
    <det id="11" name="09_SG_2_Lane4" />
    <det id="12" name="09_SG_4_Lane4" />
  </dets>
  <callingPointPairs>
    <callingPointPair id="1" name="North-South" vehicleTimeForcedLogOff="120000" signalGroupTimeForcedLogOff="0">
      <loginPoints>
        <loginPoint loginDetectorId="6" />
      </loginPoints>
      <logoffPoints>
        <logoffPoint logoffDetectorId="5" />
      </logoffPoints>
    </callingPointPair>
    <callingPointPair id="2" name="South-North" vehicleTimeForcedLogOff="200000" signalGroupTimeForcedLogOff="0">
      <loginPoints>
        <loginPoint loginDetectorId="10" />
      </loginPoints>
      <logoffPoints>
  ...
  <intergreenmatrices>
    <intergreenmatrix id="1" name="IG_SC09">
      ...
      <intergreen clearingsg="6" enteringsg="3" value="6000" />
      ...
      <intergreen clearingsg="3" enteringsg="6" value="1000" />
    </intergreenmatrix>
  </intergreenmatrices>
  <progs />
  <stages>
  ...
  <interstageProgs>
    ...
    <interstageProg id="2" cycletime="3000" intergreens="1" fromStage="2" toStage="1" name="2: Stage 2->1: Stage 1" virtualDuration="3000">
      <sgs>
        <sg sg_id="1" signal_sequence="3">
          <cmds>
            <cmd display="3" begin="0" />
  ...
  <stageProgs>
    <stageProg id="1" cycletime="90000" switchpoint="0" offset="57000" intergreens="1" fitness="0.000000" vehicleCount="0" weightBalance="3" weightStops="0" balanceFixedTimeControl="false" name="Stage 1, Stage 2">
      <interstages>
        <interstage display="1" begin="0" />
        <interstage display="2" begin="21000" />
      </interstages>
      <BALANCEInterstages>
        <BALANCEInterstage balIstId="1" earliestStart="0" originalStart="0" latestStart="89000" notes="" />
        <BALANCEInterstage balIstId="2" earliestStart="0" originalStart="21000" latestStart="89000" notes="" />
      </BALANCEInterstages>
      <activeInterstages>
      ...
      <EPICSStageParameters>
        ...
        <EPICSStageParameter stageId="2" earliestStart="0" latestEnd="90000" minimumLength="0" maximumLength="125000" preferredStart="6000" preferredEnd="21000" costPreferred="0" costNonPreferred="5" notes="" />
      </EPICSStageParameters>
      <sgs>
    ...
    <stageProg id="2" cycletime="90000" switchpoint="0" offset="57000" intergreens="1" fitness="0.000000" vehicleCount="0" weightBalance="1" weightStops="0" balanceFixedTimeControl="true" name="Stage 1, Stage 2">
      <interstages>
        <interstage display="1" begin="0" />
        <interstage display="2" begin="21000" />
      </interstages>
