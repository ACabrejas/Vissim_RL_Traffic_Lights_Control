...
class RLAgent():
	...
	# Save agents
	def save_agent(self, vissim_working_directory, model_name, Session_ID, episode):
		...
		if self.type == 'AC':
			Weights_Filename = os.path.join(vissim_working_directory, model_name, "Agents_Results", Session_ID,'Episode'+ str(episode) +'Agent'+str(self.ID)+'_Weights'+'.h5')
			Optimizer_Filename = os.path.join(vissim_working_directory, model_name, "Agents_Results", Session_ID,'Episode'+ str(episode) +'Agent'+str(self.ID)+'_Optimizer'+'.h5')
			...
			Filename = os.path.join(vissim_working_directory, model_name, "Agents_Results", Session_ID,'Episode'+ str(episode) +'Agent'+str(self.ID)+'.h5')
			print('Saving architecture, weights and optimizer state for agent-{}'.format(self.ID))
			self.model.save(Filename)

		Memory_Filename = os.path.join(vissim_working_directory, model_name, "Agents_Results", Session_ID,'Episode'+ str(episode) +'Agent'+str(self.ID)+'_Memory'+'.p')
	...
	# Reload agents
	def load_agent(self, vissim_working_directory, model_name , Session_ID, episode, best = True):
