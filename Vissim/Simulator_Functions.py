		...
		for index, agent in enumerate(Agents):
			...
			# Update the agent
				...
				if agent.intermediate_phase == False:
					...
					agent.newstate = calculate_state(state_type, state_size)
					...
					# If a different Action is chosen
						...
						previous_action = agent.compatible_actions[action]
						current_action = agent.compatible_actions[newaction]
						...
						for index_group, sig_group in agent.signal_groups:
...
def calculate_state(state_type, state_size):
